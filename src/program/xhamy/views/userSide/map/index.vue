    ...
    <o-map :marker="mapMarker" :markerIcon="markerIcon" :center="center" ref="oMap">
      <div class="po_ab tool">
        ...
        <div class="left" @click="reload">
          <img src="@/program/xhamy/img/reload.png" alt="">
        </div>
        <div class="right">
          <router-link :to="{name:'orderList'}">
            <img src="@/program/xhamy/img/list.png" alt="">
          </router-link>
          <router-link :to="{name:'centerInfo'}">
            <img src="@/program/xhamy/img/person.png" alt="">
          </router-link>
        </div>
        <!-- </div> -->
        <div class="scan">
          <div class="bac">
            <img src="@/program/xhamy/img/scanBac.png" alt="">
          </div>
          <div class="scanBtn tac" @click="scan">
            <img src="@/program/xhamy/img/scan.png" alt="">
          </div>
        </div>
      </div>
    </o-map>
