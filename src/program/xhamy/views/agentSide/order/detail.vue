        ...
        <div class="boxShadow radius10 tal pd-15">
            ...
            <van-cell title="使用时段" value="2018-02-20 00:00~2018-03-20 00:00" :border="false">
                <div>
                    ...
                    <br> {{orderDetail.end_time}}
                </div>
            </van-cell>
            <van-cell title="用户昵称" :border="false" :value="orderDetail.user_name" />
            <van-cell title="应付金额" :border="false" :value="orderDetail.should_money" />
            <van-cell title="实付金额" :border="false" :value="orderDetail.real_money" />
            <van-cell title="支付方式" :border="false" :value="orderDetail.paytype?orderDetail.paytype:'免费'" />
